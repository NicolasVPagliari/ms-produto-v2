...
public class CategoriaController {
    ...
    public ResponseEntity<List<ProdutoResponseDTO>> findProdutoByCategoria(@PathVariable Long id) {
        List<ProdutoResponseDTO> list = service.findProdutoByCategoria(id);
